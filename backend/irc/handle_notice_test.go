...
func TestHandleNotice(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			handler := HandleNotice(tt.args.linkRegex, tt.args.timestampFormat, setPendingUpdate, tt.args.currentNick, addMessage, tt.args.isValidChannel, getChannelByName, getQueryByName, addQuery)
			handler(tt.message)
